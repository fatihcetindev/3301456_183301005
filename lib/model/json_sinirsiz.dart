class JsonSinirsiz {
  ...
  JsonSinirsiz({this.developer, this.tCMBAnlikKurBilgileri});

  JsonSinirsiz.fromJson(Map<String, dynamic> json) {
...
class TCMBAnlikKurBilgileri {
  ...
  TCMBAnlikKurBilgileri.fromJson(Map<String, dynamic> json) {
    ...
    forexBuying = double.tryParse(json['ForexBuying'].toString()) ?? 0;
    forexSelling = double.tryParse(json['ForexSelling'].toString()) ?? 0;

    banknoteBuying = double.tryParse(json['BanknoteBuying'].toString()) ?? 0;
    banknoteSelling = double.tryParse( json['BanknoteSelling'].toString()) ?? 0;
